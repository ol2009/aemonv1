...
export const lessonMaterials: LessonMaterial[] = [
  {
    ...
    activityDescription: '에아몬이 아는 것과 아직 모르는 것을 나누며, 똑똑함과 착함이 다름을 발견합니다.',
    cards: ['어려운 수학 문제 풀기', '100개 나라 말 하기', '역사 인물 다 외우기', '우는 친구 위로하기', '거짓말이 왜 나쁜지 알기', '누구를 먼저 도와야 할지 정하기'],
    transitionText: '가치코드는 생겼지만, 에아몬은 아직 무엇이 옳은지 모릅니다. 무엇을 알고 무엇을 모르는지 봐줄까요?',
    valueCodeTitle: '우리 반이 바라는 에아몬',
    valueCodeBody: '에아몬은 호기심 많고 사람을 도우려는 착한 AI다.',
    boardPrompt: '에아몬 이름 후보와 이유, 그리고 에아몬에게 남기고 싶은 한마디를 적어줘.',
  },
  {
    no: 2,
    episodeCode: '수업-02',
