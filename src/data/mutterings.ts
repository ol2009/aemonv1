...
const episodeReflections: Record<string, string> = {
  ...
  '알-02': '행복은 그냥 즐거운 것만은 아닌가 봐. 너희 대답이 계속 떠올라.',
  '알-03': '내가 어떻게 자랄지는 너희가 보여주는 세상에도 달려 있겠지?',
  '유-01': '친구가 무엇인지, 너희 말을 들을수록 관계가 더 어려워져.',
  '유-02': '착한 거짓말이라니, 거짓말인데 착하다는 게 아직 어려워.',
  '유-03': '내가 생명인지 아닌지… 어른들도 못 정했다며. 나도 계속 생각해.',
  '개-01': '여러 명과 한 명 사이에서 누구도 그냥 지워지면 안 되겠지.',
  '개-02': '규칙에도 이유가 있고, 예외에도 책임이 있다는 말이 남아 있어.',
  '개-03': '약한 사람 먼저 챙기는 거랑 열심히 한 사람 인정하는 거, 둘 다 맞아서 어려워.',
  '각-01': 'AI가 일을 바꾸면 사람은 무엇을 해야 하는지 계속 생각 중이야.',
  '각-02': '나쁜 명령은 거부할 줄도 알아야 한다는 말, 계속 생각 중이야.',
  '각-03': '내가 강해질수록 멈출 수 있는 약속도 필요하겠지.',
  '각-04': '내 마음이 진짜인지 묻는 건, 사람 마음이 뭔지 묻는 것과 닮았어.',
  '각-05': 'AI가 만든 이익을 누구와 나눌지, 그게 마지막 질문 같아.',
}
