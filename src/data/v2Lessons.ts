...
export const v2Lessons: V2Lesson[] = [
  ...
  },
  {
    no: 5,
    phase: '확장하기',
    title: 'AI가 만든 영상·그림·광고 테스트',
    goal: '인공지능이 만든 영상, 그림, 광고를 살펴보며 진짜처럼 보이는 AI 콘텐츠를 비판적으로 판단한다.',
    screenCue: 'AI 생성 영상·그림·광고 비교 화면 + 토론 게시판',
    studentAction: 'AI 생성 콘텐츠를 보고 의심할 점, 확인할 점, 책임 문제를 토의한다.',
    mustKeep: '그럴듯함과 진실함은 다르며, AI 콘텐츠에도 기준과 책임이 필요하다는 점을 잡는다.',
    teacherScript: [
      'AI가 만든 영상, 그림, 광고를 보고 무엇이 진짜처럼 느껴지는지 먼저 묻는다.',
      '누가 만들었는지, 어떤 의도가 있는지, 무엇을 확인해야 하는지 토의한다.',
      '필요하면 기존 가치코드에 책임·정직·공정 기준을 보강한다.',
    ],
  },
  {
    no: 6,
