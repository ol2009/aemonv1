    ...
    <article className="mt-8">
      ...
      <section className="grid gap-5 border-b border-white/10 py-9 md:grid-cols-[88px_1fr]">
        ...
        <div>
          ...
          <p className="mt-4 text-lg leading-9 text-[#B7C7D2]">
            정작 전 세계 AI 연구자들이 인류의 존속이 걸린 문제라고 말하는 주제는 따로 있습니다. 바로 가치정렬(Value Alignment), 인공지능의 가치를 인간의 가치에 맞추는 것입니다. AI에게 인간의 가치를 어떻게 심을 것인지, 그리고 그 가치정렬이 실패하느냐, 성공하느냐에 인류의 존망이 걸려 있습니다.
          </p>
          <p className="mt-4 text-lg leading-9 text-[#B7C7D2]">
            세계 최고의 연구자들이 이 문제에 몰두하고 있고, 대다수의 AI 학자들이 경고하는 문제입니다. 인류가 가장 똑똑한 사람들을 투입해 풀고 있는 문제, 그것이 가치정렬입니다.
          </p>
          <p className="mt-4 text-lg leading-9 text-[#B7C7D2]">
